...
export default function DevPanel({ rows, onFieldChange }) {
  return (
    <div className="panel">
      <h2>Developers</h2>
      <div className="desc">
        AvaliaÃ§Ã£o por time â€” com muitos alunos em produÃ§Ã£o, a qualidade do produto Ã© o principal
      ...
      <table>
        <thead>
          <tr>
            ...
            <th>ColaboraÃ§Ã£o<br />do time (1-5)</th>
            <th>Nota Time (1-5)</th>
      ...
      <div className="note note-green">
        Reserve a coluna de destaque individual apenas para casos que realmente chamem atenÃ§Ã£o,
