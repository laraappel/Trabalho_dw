...
export default function SetupPanel({ data, setData }) {
    ...
    function updateTeamName(empresa, time, value) {
        setData((prev) => ({
            ...
            teamNames: {
                ...prev.teamNames,
                [empresa]: { ...prev.teamNames[empresa], [time]: value },
            },
        }));
    }
    ...
    function renameEmpresa(which, novoNome) {
        setData((prev) => {
            const oldA = prev.meta.empresaA;
            const oldB = prev.meta.empresaB;
        ...
        <div className="panel">
            ...
            <div className="fields-row">
                ...
                <div className="field">
                    ...
                    <input
                        type="text"
                        value={data.teamNames[m.empresaA].Caça}
                ...
                <div className="field">
                    ...
                    <input
                        type="text"
                        value={data.teamNames[m.empresaA].Transporte}
            ...
            <div className="fields-row">
                ...
                <div className="field">
                    ...
                    <input
                        type="text"
                        value={data.teamNames[m.empresaB].Caça}
                ...
                <div className="field">
                    ...
                    <input
                        type="text"
                        value={data.teamNames[m.empresaB].Transporte}
