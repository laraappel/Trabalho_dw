...
export default function ScrumMasterPanel({ rows, onFieldChange }) {
  return (
    <div className="panel">
      <h2>Scrum Master</h2>
      <div className="desc">
        AvaliaÃ§Ã£o de processo â€” um Scrum Master por empresa, atendendo os dois times.
      </div>
      <table>
        <thead>
          <tr>
      ...
      <div className="note note-dark">
        CritÃ©rio-guia: o SM nÃ£o Ã© avaliado por produzir, mas por garantir que o Scrum aconteÃ§a de
